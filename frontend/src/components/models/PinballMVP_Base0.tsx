...
Files: public/models/PinballMVP_Base.glb [41.85MB] > /Users/adrienallard/Développement/HETIC/Pinball_ThreeJs/frontend/src/components/models/PinballMVP_Base-transformed.glb [3.31MB] (92%)
*/
...
export default function Model(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF(
    "/models/PinballMVP_Base0-transformed.glb",
...
useGLTF.preload("/models/PinballMVP_Base0-transformed.glb");
