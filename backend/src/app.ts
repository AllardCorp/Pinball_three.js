...
import { registerLevelRoutes } from "./routes/level-routes.js";
...
export function createApp(
  ...
  registerLevelRoutes({
    // Le CRUD des niveaux du Maker vit dans son propre module, sur le même
    // principe que leaderboard/score-claim.
    app,
    db,
    getSession,
  });
